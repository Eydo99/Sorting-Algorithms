...
public class BarChartPane {
    ...
    // ── Complexity map ───────────────────────────────────────────
    private static final java.util.Map<String, String> COMPLEXITY =
            java.util.Map.of(
                    "BubbleSort",    "O(n²)",
                    "InsertionSort", "O(n²)",
                    "SelectionSort", "O(n²)",
    ...
    public BarChartPane(String algoName, int[] originalArray) {
        ...
        // ── Root panel ──
        root = new VBox(header, canvasWrapper, statsBar);
...
// Color logic
    ...
    // ─────────────────────────────────────────────────────────────
    // setFinalArray() — the fully sorted version for color comparison
    // ─────────────────────────────────────────────────────────────
